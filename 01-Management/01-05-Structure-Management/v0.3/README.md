...
summary: "Главный README файл раздела управления структурой v0.3, содержащий ссылки на все инструкции."
topics: [structure, management, documentation]
language: ru
---

# Structure Management v0.3

Добро пожаловать в версию 0.3 системы управления структурой компании Galt.

Эта версия является развитием версии v0.2.
