---
id: project-deployment-template-v04
type: template
status: approved
ai_access: true
owner: Management
...
summary: "Шаблон инструкций для развертывания нового проекта в структуре Galt (v0.4)."
topics: [project, template, deployment, structure]
language: ru
---

# Шаблон Развертывания Нового Проекта (v0.4)

Эта инструкция предназначена для создания (развертывания) нового проекта в папке `05-Projects` в соответствии со стандартами Galt v0.4.
