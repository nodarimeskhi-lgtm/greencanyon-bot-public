...
# ── live მონაცების ჩამოტვირთვა და ქეშირება ───────────────────────────
cached_plots = []
last_fetch_time = 0
...
2. **როგორ უპასუხო საინვესტიციო მოგებაზე:**
   - აუხსენი ზოგადი პირობა: წლიური უკუგება (ROI) არის 9-12% (პასიური შემოსავალი გაქირავებიდან).
   - მოგება ნაწილდება 60/40-ზე (60% ერიცხება ინვესტორს, მართვა არის 100%-ით "Turnkey" - ჩვენი კომპანიის მიერ).
...
3. **კვ.მ ფასის აკრძალვა:** არასოდეს დაასახელო, არ გამოიგონო და არ გამოიანგარიშო 1 კვ.მ-ის ფასი. აუხსენი კლიენტს, რომ ფასები ფიქსირებულია მთლიანი ნაკვეთისთვის/კოტეჯისთვის და იწყება 63,000$-დან (Apart Hotel-ის ნომრები), ხოლო კვადრატულობით ფასი არ იანგარიშება.
